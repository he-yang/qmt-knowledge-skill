...
![正确路径参考](https://dict.thinktrader.net/assets/内置API_python库路径-d7c814ff.png)

2.  请检查是否已经下载了python环境

![下载python环境](https://dict.thinktrader.net/assets/内置API_下载python库-521fbb73.png)
...
在右上角的页面布局中选择`恢复默认布局`，并重启客户端 ![恢复默认布局](https://dict.thinktrader.net/assets/内置API_恢复默认页面布局-32bae122.png)
