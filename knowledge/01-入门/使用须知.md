...
![Alt text](https://dict.thinktrader.net/assets/内置API_K线回放-f0f166ba.png)
...
![Alt text](https://dict.thinktrader.net/assets/内置API_停止策略1-660e5a2b.png)

![Alt text](https://dict.thinktrader.net/assets/内置API_停止策略2-c93e6732.png)

![Alt text](https://dict.thinktrader.net/assets/内置API_停止策略3-2ebf0e22.png)

![Alt text](https://dict.thinktrader.net/assets/内置API_停止策略4-dfca1cc1.png)
...
![Alt text](https://dict.thinktrader.net/assets/内置API_数据下载1-bd7db774.png) 而且，在批量下载中可以设置定时下载，这样可以方便地每天自动下载当日的行情数据。 ![Alt text](https://dict.thinktrader.net/assets/内置API_定时下载-034ff844.png)